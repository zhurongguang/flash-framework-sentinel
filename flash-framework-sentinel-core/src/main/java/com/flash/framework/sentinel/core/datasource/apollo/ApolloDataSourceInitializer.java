    ...
    public void localInit(SentinelConfigure sentinelConfigure) {
        ...
        if (StringUtils.isNotBlank(sentinelConfigure.getFlowRuleDataIdSuffix())) {
            ReadableDataSource<String, List<FlowRule>> flowRuleDataSource = new ApolloDataSource<>(sentinelConfigure.getApolloNamespace(),
                    buildDataId(sentinelConfigure.getFlowRuleDataIdSuffix()), null, (source) -> JSON.parseArray(source, FlowRule.class));
        ...
        if (StringUtils.isNotBlank(sentinelConfigure.getDegradeRuleDataIdSuffix())) {
            ReadableDataSource<String, List<DegradeRule>> degradeRuleDataSource = new ApolloDataSource<>(sentinelConfigure.getApolloNamespace(),
                    buildDataId(sentinelConfigure.getDegradeRuleDataIdSuffix()), null, (source) -> JSON.parseArray(source, DegradeRule.class));
        ...
        if (StringUtils.isNotBlank(sentinelConfigure.getSystemRuleDataIdSuffix())) {
            ReadableDataSource<String, List<SystemRule>> systemRuleDataSource = new ApolloDataSource<>(sentinelConfigure.getApolloNamespace(),
                    buildDataId(sentinelConfigure.getSystemRuleDataIdSuffix()), null, (source) -> JSON.parseArray(source, SystemRule.class));
        ...
        if (StringUtils.isNotBlank(sentinelConfigure.getParamFlowDataIdSuffix())) {
            ReadableDataSource<String, List<ParamFlowRule>> paramFlowDataSource = new ApolloDataSource<>(sentinelConfigure.getApolloNamespace(),
                    buildDataId(sentinelConfigure.getParamFlowDataIdSuffix()), null, (source) -> JSON.parseArray(source, ParamFlowRule.class));
    ...
    public void tokenClientInit(SentinelConfigure sentinelConfigure) {
        ...
        if (StringUtils.isNotBlank(sentinelConfigure.getClusterClientConfigDataIdSuffix())) {
            ReadableDataSource<String, ClusterClientConfig> clusterClientConfigNacosDataSource = new ApolloDataSource<>(sentinelConfigure.getApolloNamespace(),
                    buildDataId(sentinelConfigure.getClusterClientConfigDataIdSuffix()), null, source -> JSON.parseObject(source, ClusterClientConfig.class));
        ...
        if (StringUtils.isNotBlank(sentinelConfigure.getClusterDataIdSuffix())) {
            ...
            ReadableDataSource<String, ClusterClientAssignConfig> clientAssignDs = new ApolloDataSource<>(sentinelConfigure.getRemoteAddress(),
                    buildDataId(sentinelConfigure.getClusterDataIdSuffix()), null, source -> {
